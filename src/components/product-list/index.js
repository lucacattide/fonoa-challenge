                        ...
                        <section className="w-30"
                            ...
                            <div className="card ma-16">
                                ...
                                <div className="card-actions justify-content-center pa-4">
                                    ...
                                    <button className="x-small outlined" data-testid="btn-item-add" onClick={() => this.handleAdd(i)}>
                                            Add To Cart
                                     </button> :
                                        <button className="x-small danger" data-testid="btn-item-remove" onClick={() => this.handleRemove(i)}>
                                            Remove
                                    </button>
                                    }
                                </div>
